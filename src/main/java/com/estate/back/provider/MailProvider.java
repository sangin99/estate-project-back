...
// - 인터넷을 통해서 이메일 메세지를 보내고 받는 데 사용되는 통신 포로토콜
// - 메일 서버 및 기타 메시지 전송 에이전트(MTA)에서 메일 전송, 수신, 중계를 할 때 사용됨
// - 기본 포트 : TCP 25

// TLS (Transport Layer Security) :
// - 전송 계층 보안
// - 인터넷에서 의사소통을 위한 개인 정보와 데이터 보안을 위해 사용되는 보안 포로토콜
...
public class MailProvider {
    ...
    private String getText (String authNUmber) {
        String text = 
            "<h2 style='text-align: center'>estate 인증 번호</h2>" + "<p>요청하신 email 인증 번호는 <strong style='color: red;'>"
            + authNUmber +
            "</strong>입니다.</p>";
